            ...
            <div className="p-5 max-w-3xl mx-auto space-y-6">
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                    ...
                    <div className="prose prose-slate prose-sm max-w-none text-slate-600 space-y-5 leading-relaxed">
                        ...
                        <p>
                            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <span className="font-bold text-slate-800">https://zeppe.in/</span> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
                        </p>

                        <p>
                            The Platform is owned by <span className="font-bold text-slate-800">Zeppe</span>, a company incorporated under the Companies Act, 1956 with its registered office at <span className="font-bold text-slate-800">Pupri, 843320, Bihar</span> (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
                        </p>
                        ...
                        <p className="font-black text-slate-800 uppercase text-xs tracking-wide border-l-4 border-brand-500 pl-4 py-2 bg-slate-50">
